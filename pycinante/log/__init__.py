...
_defaults, _ = optional_import(module="loguru", name="_defaults")
...
class logger:
    ...
    @staticmethod
    def remove(handler_id: Optional[Union[int, type(sys.stderr), str]] = None) -> None:
        """
    ...
    @staticmethod
    def console(level: Optional[int | str] = None, format: Optional[str | Callable] = None, **kwargs: Any) -> None:
        """
